...
function ll  =GET_Certian_Match(input_file,match)% enter the file name which include the files name of genemerge output
global directory;
x=1;
mingeneno=2; % threshold number of idenifed gene per each GO  
percentage=1;
numofclusters=0;
r=zeros(10,8);
ll={'null'};
                        ...
                        if fl~=0
                                ...
                                B=flipud(B);
                                        ...
                                        for i=1:size(B,1)
                                            ...
                                            v=str2num(B{i,1});
                                            response=B(i,4);
                                            sure=isempty(strfind(response{:},match));
                                       
                                            %SL= 0.00001 0.00005 0.0001  0.0005 0.001  0.005 0.01 0.05
                                            
                                            if percentage~=0
                                                            if(u<=0.00001 &&  sure~=1 && ((v*100)>percentage||str2num(e{1})>= mingeneno))     % siginificance level=1.E-5
                                                                r(count1,1)=v;
                                                                ll(numofclusters,putin)=strcat(B(i,1),B(i,3),B(i,4));
                                                                putin=putin+1;
                                                           count1=count1+1;
                                                            end
                                                            if (u<=0.00005 && 0.00001<u &&  sure~=1 && ((v*100)>percentage||str2num(e{1})>= mingeneno)) % siginificance level=5.E-5
                                                                r(count2,2)=v;
                                                                  ll(numofclusters,putin)=strcat(B(i,1),B(i,3),B(i,4));
                                                                  putin=putin+1;
                                                           count2=count2+1;
                                                            end
                                                            if (u<=0.0001 && 0.00005<u &&  sure~=1&& ((v*100)>percentage||str2num(e{1})>= mingeneno))% siginificance level=1E-4
                                                                r(count3,3)=v;
                                                                  ll(numofclusters,putin)=strcat(B(i,1),B(i,3),B(i,4));
                                                                  putin=putin+1;
                                                           count3=count3+1;
                                                            end
                                                            if (u<=0.0005 && 0.0001<u &&  sure~=1 && ((v*100)>percentage||str2num(e{1})>= mingeneno))% siginificance level=5E-4
                                                                r(count4,4)=v;
                                                                  ll(numofclusters,putin)=strcat(B(i,1),B(i,3),B(i,4));
                                                                  putin=putin+1;
                                                           count4=count4+1;
                                                            end
                                                            if (u<=0.001&& 0.0005<u &&  sure~=1&& ((v*100)>percentage||str2num(e{1})>= mingeneno))% siginificance level=1E-3
                                                                r(count5,5)=v;
                                                                  ll(numofclusters,putin)=strcat(B(i,1),B(i,3),B(i,4));
                                                                  putin=putin+1;
                                                           count5=count5+1;
                                                            end
                                                            if (u<=0.005 && 0.001<u &&  sure~=1&& ((v*100)>percentage||str2num(e{1})>= mingeneno))% siginificance level=5E-3
                                                                r(count6,6)=v;
                                                                  ll(numofclusters,putin)=strcat(B(i,1),B(i,3),B(i,4));
                                                                  putin=putin+1;
                                                           count6=count6+1;
                                                            end
                                                            if (u<=0.01 && 0.005<u && sure~=1 && ((v*100)>percentage||str2num(e{1})>= mingeneno))% siginificance level=1E-2
                                                                r(count7,7)=v;
                                                                  ll(numofclusters,putin)=strcat(B(i,1),B(i,3),B(i,4));
                                                                  putin=putin+1;
                                                           count7=count7+1;
                                                            end
                                                            if (u<=0.05 && 0.01<u && sure~=1&& ((v*100)>percentage||str2num(e{1})>= mingeneno))% siginificance level=5E-2
                                                                r(count8,8)=v;
                                                                  ll(numofclusters,putin)=strcat(B(i,1),B(i,3),B(i,4));
                                                                  putin=putin+1;
                                                           count8=count8+1;
